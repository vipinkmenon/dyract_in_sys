...
################################################################
# This is a generated script based on design: dyract_sys
#
...
proc create_root_design { parentCell } {
  ...
  set pci_exp_rxn [ create_bd_port -dir I -from 3 -to 0 pci_exp_rxn ]
  set pci_exp_rxp [ create_bd_port -dir I -from 3 -to 0 pci_exp_rxp ]
  set pci_exp_txn [ create_bd_port -dir O -from 3 -to 0 pci_exp_txn ]
  set pci_exp_txp [ create_bd_port -dir O -from 3 -to 0 pci_exp_txp ]
  ...
  # Create port connections
  connect_bd_net -net LMB_Rst_1 [get_bd_pins microblaze_0_local_memory/LMB_Rst] [get_bd_pins rst_mig_7series_0_100M/peripheral_reset]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins dyract_0/m_axi_mm2s_aclk] [get_bd_pins dyract_0/m_axi_s2mm_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x80000000 [get_bd_addr_spaces dyract_0/m_axi_mm2s] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
  create_bd_addr_seg -range 0x20000000 -offset 0x80000000 [get_bd_addr_spaces dyract_0/m_axi_s2mm] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
